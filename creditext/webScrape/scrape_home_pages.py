...
def scrape(url):
    ...
    try:
        ...
        description = (
            description_meta['content'] if description_meta else 'No description found'
        )
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--domains_path',
        type=str,
        default='../../data/dqr/domain_pc1.csv',
        help='dqr dataset path',
    )
    parser.add_argument(
        '--output_path', type=str, default='../../data/scrape/', help='output path'
    )
